...
Currently impersonating Claude Code CLI <!-- cc-target-version:start -->**2.1.281**<!-- cc-target-version:end -->,
...
docker run --rm -p 8317:8317 \
  ...
  ghcr.io/arkptz/cpa-mimicry:0.4.0
```
...
```dockerfile
COPY --from=ghcr.io/arkptz/cc-mimicry:0.4.0 /plugin/cc-mimicry.so /plugins/linux/amd64/cc-mimicry.so
```
